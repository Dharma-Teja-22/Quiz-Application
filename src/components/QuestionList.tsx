      ...
      {isGameStarted ? (
        <div className="space-y-2">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {question.options.map((option, optIndex) => (
                      <div
                        key={optIndex}
                        className={`relative p-2 rounded-xl transition-all duration-200 bg-[#00aae7]/5 text-miracle-black ring-2 ring-[#00aae7]/50 ${
                          optIndex === question.correctAnswer &&
                          question.showAnswer &&
                          "bg-miracle-lightBlue/50"
                        }`}
                      >
          ...
          {timeLeft === 0 && (
            <div className="flex justify-center">
              {questions.some(question => !question.showAnswer) && (questions[currentQuestionIndex]?.showAnswer ? (
                <button
                  ref={nextBtnRef}
                  onClick={() => {
              ...
              {
                questions.every(question => question.showAnswer) && gameStatus !== "finished" && (
                  <button
        ...
        <div className="text-center py-8 rounded-xl h-full w-full flex flex-col justify-center items-center">
          <div className="text-miracle-darkGrey font-bold sm:text-base p-4 md:p-0">
            <p>
              <span className="text-miracle-black">
